...
<html class="no-js" lang="en">
	...
	<header id="home" class="qt-header parallax-container scrollspy" >
		<div class="parallax" data-start="width:100%;height:100%;top: 0%;left: 0%;" data-end="width:260%;height:260%;top:-80%;left:-80%;"><img src="resources/images/galaxy-1.jpg" alt="background"></div>
		<div class="qt-valign-wrapper">
			<div class="qt-valign">
				<div class="container center-align"  >
					<img src="resources/images/logo.png" class="logo" alt="Sonik template">
					<h4><a href="#log" style="color:white;">Login</a>
							&nbsp;&nbsp;&nbsp;
	...
	<div id="menu" class="qt-menu-wrapper" data-0-top>
		<nav id="stickymenu" class="qt-menu grey-text text-lighten-4"  >
			...
			<ul class="qt-desktopmenu">
				<li><a href="test" class="qwsmoothscroll">HOME</a></li>
	...
	<!-- ====================== MENU END ================================================ -->
			...
			<main class="qt-main">
				...
				<div id="music" class="section section-music parallax-container scrollspy" >
					<div class="parallax"><img src="resources/images/parallax3.jpg" alt="background">
					</div>
					...
					<div id="carouselmusic" class="qt-gridstackCarousel-container">
						...
						<div class="carousel qt-gridstackCarousel" data-vpadding="50" data-time_constant="500"   data-dist="-30"  data-shift="-20" data-padding="20" data-full_width="0" data-100p-top="opacity:0;" data-80p-top="opacity:0;" data-50p-top="opacity:1;" data-30p-top="opacity:1;" data-top-bottom="opacity:0;">
							...
							<div class="carousel-item">
								<img src="resources/images/album.jpg"  width="300" height="300" alt="Album title">
				...
				<div id="photos" class="section section-photos black scrollspy">
					...
					<div class="qtgallery"  data-bottom-top="opacity:0;" data-center-top="opacity:1;">
					  	<div><img src="resources/images/gallery.jpg"  alt="photo"/></div>
					  	<div><img src="resources/images/gallery.jpg"  alt="photo"/></div>
					  	<div><img src="resources/images/gallery.jpg"  alt="photo"/></div>
					  	<div><img src="resources/images/gallery.jpg"  alt="photo"/></div>
					  	<div><img src="resources/images/gallery.jpg"  alt="photo"/></div>
				...
				<div id="bio" class="section section-bio parallax-container qt-fullscreen scrollspy" >
					<div class="parallax" ><img src="resources/images/gallery.jpg" alt="background"></div>
					<div class="container">
				...
				<div id="presskit" class="section section-presskit parallax-container scrollspy" >
					<div class="parallax"><img src="resources/images/galaxy-2.jpg" alt="background"></div>
				...
				<div id="video" class="section section-video  scrollspy" >
					<div class="qt-framed flow-text"  data-100p-top="opacity:0;" data-80p-top="opacity:0;" data-30p-top="opacity:1;" >
						...
						<div class="content">
							<div class="qtvideos">
							  	<div><a href="https://www.youtube.com/watch?v=AVIzExWnoNg" class="swipebox"><img src="resources/images/gallery.jpg" alt="video"><span class="lnr lnr-film-play"></span></a><h5>Hyte party Ibiza</h5></div>
							  	<div><a href="https://www.youtube.com/watch?v=VbWB_rvCXTs" class="swipebox"><img src="resources/images/gallery.jpg" alt="video"><span class="lnr lnr-film-play"></span></a><h5>Felix Crocher live</h5></div>
							  	<div><a href="https://www.youtube.com/watch?v=bSto8j4ziCg" class="swipebox"><img src="resources/images/gallery.jpg" alt="video"><span class="lnr lnr-film-play"></span></a><h5>Nicole Moudaber live</h5></div>
							  	<div><a href="https://www.youtube.com/watch?v=rhUvo4xj2oU" class="swipebox"><img src="resources/images/gallery.jpg" alt="video"><span class="lnr lnr-film-play"></span></a><h5>Hardwell live</h5></div>
							  	<div><a href="https://www.youtube.com/watch?v=5vHRUsP20dQ" class="swipebox"><img src="resources/images/gallery.jpg" alt="video"><span class="lnr lnr-film-play"></span></a><h5>Maceo Plex live</h5></div>
							</div>
						</div>
					</div>
				</div>
