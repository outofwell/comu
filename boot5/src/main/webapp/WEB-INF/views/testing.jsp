...
<html class="no-js" lang="en">
	<head>
		...
		<link href='resources/css/qticons.css' rel='stylesheet' type='text/css'>
		<link href='resources/css/bootstrap.min.css' rel='stylesheet' type='text/css'>
		<link rel="stylesheet" href="resources/css/qt-main.css"><!-- INCLUDES THE CSS FRAMEWORK VIA #IMPORT AND SASS -->
		<link rel="shortcut icon" type="http://qantumthemes.xyz/sonikhtml/png" href="http://qantumthemes.xyz/sonikhtml/images/favicon.png"/>
</head>
	...
	<!-- QT HEADER END ================================ -->
		...
		<header id="home" class="qt-header parallax-container scrollspy" >
			<div class="parallax" data-start="width:100%;height:100%;top: 0%;left: 0%;" data-end="width:260%;height:260%;top:-80%;left:-80%;"><img src="http://qantumthemes.xyz/sonikhtml/images/galaxy-1.jpg" alt="background"></div>
			<div class="qt-valign-wrapper">
				<div class="qt-valign">
					<div class="container center-align"  data-50p-top="opacity:1;margin-top:0px" data-30p-top="opacity:1;" data-0p-top="opacity:0;margin-top:-700px">
						<img src="http://qantumthemes.xyz/sonikhtml/images/logo.png" class="logo" alt="Sonik template">
		...
		<div id="music" class="section section-music parallax-container scrollspy" >
			<div class="parallax"><img src="http://qantumthemes.xyz/sonikhtml/images/parallax3.jpg" alt="background">
			</div>
			...
			<div id="carouselmusic" class="qt-gridstackCarousel-container">
				...
				<div class="carousel qt-gridstackCarousel" data-vpadding="50" data-time_constant="500"   data-dist="-30"  data-shift="-20" data-padding="20" data-full_width="0" data-100p-top="opacity:0;" data-80p-top="opacity:0;" data-50p-top="opacity:1;" data-30p-top="opacity:1;" data-top-bottom="opacity:0;">
					...
					<div class="carousel-item">
						<img src="http://qantumthemes.xyz/sonikhtml/images/album-8.jpg"  width="300" height="300" alt="Album title">
					...
					<div class="carousel-item">
						<img src="http://qantumthemes.xyz/sonikhtml/images/album-1.jpg"  width="300" height="300" alt="Album title">
					...
					<div class="carousel-item">
						<img src="http://qantumthemes.xyz/sonikhtml/images/album-3.jpg"  width="300" height="300" alt="Album title">
					...
					<div class="carousel-item">
						<img src="http://qantumthemes.xyz/sonikhtml/images/album-4.jpg"  width="300" height="300" alt="Album title">
						<h5>Technodelic</h5>
						<a href="#modal1" class="btn modal-trigger" data-iframe="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/171764879&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"><span class="lnr lnr-music-note"></span></a>
					</div>

					<div class="carousel-item">
						<img src="http://qantumthemes.xyz/sonikhtml/images/album-5.jpg"  width="300" height="300" alt="Album title">
						<h5>Born sinners</h5>
						<a href="#modal1" class="btn modal-trigger" data-iframe="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/240890020&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"><span class="lnr lnr-music-note"></span></a>
					</div>

					<div class="carousel-item">
						<img src="http://qantumthemes.xyz/sonikhtml/images/album-6.jpg"  width="300" height="300" alt="Album title">
						<h5>Dark Spektre</h5>
						<a href="#modal1" class="btn modal-trigger" data-iframe="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/239027362&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"><span class="lnr lnr-music-note"></span></a>
					</div>

					<div class="carousel-item">
						<img src="http://qantumthemes.xyz/sonikhtml/images/album-7.jpg"  width="300" height="300" alt="Album title">
						<h5>Supernova</h5>
						<a href="#modal1" class="btn modal-trigger" data-iframe="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/239027362&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"><span class="lnr lnr-music-note"></span></a>
					</div>

					<div class="carousel-item">
						<img src="http://qantumthemes.xyz/sonikhtml/images/album-2.jpg"  width="300" height="300" alt="Album title">
						<h5>Space Journey</h5>
						<a href="#modal1" class="btn modal-trigger" data-iframe="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/239027362&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"><span class="lnr lnr-music-note"></span></a>
					</div>
				</div>
		...
		<div id="photos" class="section section-photos black scrollspy">
			...
			<div class="qtgallery"  data-bottom-top="opacity:0;" data-center-top="opacity:1;">
			  	<div><img src="http://qantumthemes.xyz/sonikhtml/images/gallery1.jpg"  alt="photo"/></div>
			  	<div><img src="http://qantumthemes.xyz/sonikhtml/images/gallery2.jpg"  alt="photo"/></div>
			  	<div><img src="http://qantumthemes.xyz/sonikhtml/images/gallery3.jpg"  alt="photo"/></div>
			  	<div><img src="http://qantumthemes.xyz/sonikhtml/images/gallery4.jpg"  alt="photo"/></div>
			  	<div><img src="http://qantumthemes.xyz/sonikhtml/images/gallery5.jpg"  alt="photo"/></div>
			  	<div><img src="http://qantumthemes.xyz/sonikhtml/images/gallery6.jpg"  alt="photo"/></div>
			  	<div><img src="http://qantumthemes.xyz/sonikhtml/images/gallery7.jpg"  alt="photo"/></div>
			  	<div><img src="http://qantumthemes.xyz/sonikhtml/images/gallery8.jpg"  alt="photo"/></div>
			</div>
		</div>
		<!-- ====================== SECTION PHOTOS END ================================================ -->
		...
		<div id="bio" class="section section-bio parallax-container qt-fullscreen scrollspy" >
			<div class="parallax" ><img src="http://qantumthemes.xyz/sonikhtml/images/bio.jpg" alt="background"></div>
			<div class="container">
		...
		<div id="presskit" class="section section-presskit parallax-container scrollspy" >
			<div class="parallax"><img src="http://qantumthemes.xyz/sonikhtml/images/galaxy-2.jpg" alt="background"></div>
						...
						<div class="container">
							<div class="qt-framed center-align"  data-100p-top="opacity:0;" data-80p-top="opacity:0;" data-30p-top="opacity:1;" >
								...
								<p class="center-align">
									<a class="btn waves-effect waves-light btn-large" href="downloads/presskit.zip" target="_blank">DOWNLOAD</a>
								</p>
							</div>
						</div>
		...
		<div id="video" class="section section-video  scrollspy" >
			<div class="qt-framed flow-text"  data-100p-top="opacity:0;" data-80p-top="opacity:0;" data-30p-top="opacity:1;" >
				...
				<div class="content">
					<div class="qtvideos">
					  	<div><a href="https://www.youtube.com/watch?v=AVIzExWnoNg" class="swipebox"><img src="http://qantumthemes.xyz/sonikhtml/images/video1.jpg" alt="video"><span class="lnr lnr-film-play"></span></a><h5>Hyte party Ibiza</h5></div>
					  	<div><a href="https://www.youtube.com/watch?v=VbWB_rvCXTs" class="swipebox"><img src="http://qantumthemes.xyz/sonikhtml/images/video2.jpg" alt="video"><span class="lnr lnr-film-play"></span></a><h5>Felix Crocher live</h5></div>
					  	<div><a href="https://www.youtube.com/watch?v=bSto8j4ziCg" class="swipebox"><img src="http://qantumthemes.xyz/sonikhtml/images/video3.jpg" alt="video"><span class="lnr lnr-film-play"></span></a><h5>Nicole Moudaber live</h5></div>
					  	<div><a href="https://www.youtube.com/watch?v=rhUvo4xj2oU" class="swipebox"><img src="http://qantumthemes.xyz/sonikhtml/images/video4.jpg" alt="video"><span class="lnr lnr-film-play"></span></a><h5>Hardwell live</h5></div>
					  	<div><a href="https://www.youtube.com/watch?v=5vHRUsP20dQ" class="swipebox"><img src="http://qantumthemes.xyz/sonikhtml/images/video5.jpg" alt="video"><span class="lnr lnr-film-play"></span></a><h5>Maceo Plex live</h5></div>
		...
		<footer class="qt-footer parallax-container blue-grey-text text-lighten-5">
			<div class="parallax"><img src="http://qantumthemes.xyz/sonikhtml/images/galaxy-3.jpg" alt="background"></div>
			<div class="container center-align"  >
				<h3 class="qt-footertitle"><img src="http://qantumthemes.xyz/sonikhtml/images/logo-footer.png" alt="Sonik Music HTML template"></h3>
		...
		<script src="resources/js/jquery-3.1.1.min.js"></script><!--  JQUERY VERSION MUST MATCH WORDPRESS ACTUAL VERSION (NOW 1.12) -->

		<!--  CUSTOM JS LIBRARIES: =========================================================== -->
		<script src="resources/js/materialize.js"></script>
		<script src="resources/js/slick.js"></script>
		<script src="resources/js/particles.js"></script>
		<script src="resources/js/skroller.js"></script>
		<script src="resources/js/ios-orientationchange-fix.js"></script>
		<script src="resources/js/swipebox.js"></script>
