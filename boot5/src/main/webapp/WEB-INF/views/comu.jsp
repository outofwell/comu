				...
				$('#under').click(
						function() {
							jQuery.fn.extend({
								...
								setSelection : function(selectionStart,
										selectionEnd) {
									if (this.length == 0)
										return this;
									input = this[0];
											...
											$
													.each(
															...
															function(index,
																	item) {
																//img 주소 : 테스트용 임시 주소!!
																msg += '<td class="btn btn-white"><a href="load?filenum='
																		+ item.filenum
																		+ '"><img src="resources/covers/'+item.cover_re+'" style="width:80px; height:80px; border-radius:5px;"></a><br>';
																msg += item.file_title
																		+ '</td>';
																if ((index + 5) % 4 == 0) {
																	msg += "</tr><tr>";
							...
							<div class="col-md-6">
								...
								<div class="row">
									...
									<div class="col-md-2">
										...
										<button class="btn btn-primary" name="under" id="under"
